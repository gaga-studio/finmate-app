  ...
  return (
    <div className="relative min-h-full">
      <header className="flex items-center justify-between px-5 pb-1 pt-14">
        <h1 className="text-[20px] font-extrabold tracking-tight text-ink">finmate</h1>
        <button
          type="button"
      ...
      <div className="mx-5 mt-2 flex items-center gap-2 rounded-full bg-elevated px-4 py-2.5 shadow-soft">
        ...
        <span className="text-[13px] font-medium text-ink-faint">그룹 찾아보기</span>
      </div>
      ...
      <section className="mt-5 pb-6">
        <div className="flex items-center justify-between px-5">
          <h2 className="text-[15px] font-bold text-ink">오늘의 스토리</h2>
          <SegmentedControl
            id="story-sort"
            items={[
        ...
        <StoryGrid stories={stories} openId={null} onOpen={() => {}} />
      </section>
    </div>
  )
}
