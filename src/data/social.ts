...
export const STORIES: Story[] = [
  ...
  },
  {
    ...
    period: 'weekly',
    headline: '바이오 ETF,\n이번 주 첫 매수!',
    subline: '커피 3번 참아서 5만원 투자했어요. ',
    top3: [
      { label: 'KODEX 바이오', value: '+5.83%', price: '8,350원', change: '▲ 460원', changePct: '5.83%', direction: 'up' },
      { label: '셀트리온', value: '+0.06%', price: '175,800원', change: '▲ 100원', changePct: '0.06%', direction: 'up' },
    ],
    artKey: 'story-bio',
    likes: 171,
